...
DOC = tree.Document()
EGG1 = DOC.xml_append_child(tree.Element(None, 'egg0'))
EGG1.xml_append_child(tree.Text('0'))
EGG2 = DOC.xml_append_child(tree.Element(None, 'egg1'))
EGG2.xml_append_child(tree.Text('1'))
EGG3 = DOC.xml_append_child(tree.Element(None, 'egg0'))
EGG3.xml_append_child(tree.Text('0'))
EGG4 = DOC.xml_append_child(tree.Element(None, 'egg1'))
EGG4.xml_append_child(tree.Text('1'))
EGG5 = DOC.xml_append_child(tree.Element(None, 'egg0'))
EGG5.xml_append_child(tree.Text('0'))
