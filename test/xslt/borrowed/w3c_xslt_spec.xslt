...
<!-- Version: $Id: w3c-xmlspec.xslt,v 1.1 2001-09-15 21:31:01 molson Exp $ -->
...
<!-- This stylesheet is copyright (c) 2000-2001 by its authors.  Free
...
<!--
  ...
  <xsl:template match="sitem[not(1)]">
    <br/>
    <xsl:apply-templates/>
  </xsl:template>
