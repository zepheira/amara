 ...
 *
 * Parser generated by BisonGen on Sun Jul 27 00:52:08 2008.
 */
...
static const char* const rule_info[] = {
  ...
  "amara/xslt/xpatterns/xpattern.bgen: line 348",
  "amara/xslt/xpatterns/xpattern.bgen: line 357",
  "amara/xslt/xpatterns/xpattern.bgen: line 367",
  "amara/xslt/xpatterns/xpattern.bgen: line 378",
...
case 18: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 348
   * ChildOrAttributeAxisSpecifier:
   */
...
case 19: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 357
   * ChildOrAttributeAxisSpecifier: '@'
   */
...
case 20: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 367
...
case 21: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 378
...
case 20: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 403 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:403, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
    TRACE("returning DOUBLE_SLASH\n");
  }
...
case 21: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 408 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:408, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
    TRACE("returning NodeType\n");
  }
...
case 22: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 413 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:413, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
...
case 23: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 416 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:416, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
...
case 24: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 420 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:420, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
...
case 25: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 423 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:423, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
...
case 26: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 427 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:427, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
    TRACE("returning NameTest\n");
  }
...
case 27: {
  /* from amara/xslt/xpatterns/xpattern.bgen, line 431 */
  if (self->verbose) {
    char *repr = unicode_escape(yypos, (yyend - yypos));
    TRACE("accepting rule at amara/xslt/xpatterns/xpattern.bgen:431, matched ");
    TRACE("'%s', ", repr);
    PyMem_Del(repr);
    TRACE("switching to start condition INITIAL, ");
    TRACE("returning '%c'\n", (int)(*yypos));
