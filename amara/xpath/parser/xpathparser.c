 ...
 *
 * Parser generated by BisonGen on Fri Apr 18 12:04:37 2008.
 */
...
static PyObject *yy_import(const char *yymodule, const char *yyname)
{
  ...
  yyresult = PyImport_ImportModule(yymodule);
  if (yyresult != NULL && yyname != NULL) {
    /* convert to a borrowed reference from sys.modules */
    Py_DECREF(yyresult);
    /* get the identifier from the module object */
    yyresult = PyObject_GetAttrString(yyresult, yyname);
  }
  return yyresult;
}
...
/* If any of the YY_MALLOC, YY_REALLOC, YY_FREE macros are not defined,
 * ensure that all are undefined */
#if (defined(YY_MALLOC) || defined(YY_REALLOC) || defined(YY_FREE))
#ifndef YY_MALLOC
#error YY_MALLOC must be defined if YY_REALLOC or YY_FREE is defined.
#endif
#ifndef YY_REALLOC
#error YY_REALLOC must be defined if YY_MALLOC or YY_FREE is defined.
#endif
#ifndef YY_FREE
#error YY_FREE must be defined if YY_MALLOC or YY_REALLOC is defined.
#endif
#endif
#ifndef YY_MALLOC
...
#ifndef YY_CHAR_SIZE
#ifdef YY_CHAR_TYPE
#error YY_CHAR_SIZE must be defined for YY_CHAR_TYPE
#endif
/* default to UTF-16 encoding for text */
#define YY_CHAR_SIZE 2
#endif

#ifndef YY_CHAR_TYPE
#if YY_CHAR_SIZE >= 4
#define YY_CHAR_TYPE unsigned int
#elif YY_CHAR_SIZE >= 2
#define YY_CHAR_TYPE unsigned short
#else
#define YY_CHAR_TYPE unsigned char
#endif
#endif
typedef YY_CHAR_TYPE YY_Char;

#ifndef YY_VALUE_TYPE
#define YY_VALUE_TYPE YY_Char *
#define YY_VALUE_NEW(yyptr, yylen) (yyptr)
#define YY_VALUE_DEL(yyptr)
#endif
typedef YY_VALUE_TYPE YY_Value;

typedef int YY_State;
...
typedef struct {
  YY_Char *yybuffer;            /* the complete input as unicode */
  YY_Char *yypos;               /* the current position within the input */
  YY_Char *yyend;               /* the end of the input buffer */

  int yystart;                  /* the current lexical start state */
  ...
  YY_Error yyerror_code;
  unsigned int yyerror_line;
  unsigned int yyerror_column;
  const char *yyerror_string;
#if YY_DEBUG
  int yydebug;
#endif
} YY_Parser;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 299 ? token_translations[x] : 85)

/* vector of items of all rules. */
static const int rhs_tokens[] = {
       0,    59,     0,    58,     0,    46,     0,    46,    59,     0,
      66,     0,    60,     0,    59,    46,    60,     0,    67,     0,
      62,    63,     0,    62,    63,    61,     0,    68,     0,    64,
       0,    61,    64,     0,    43,     4,     0,    69,     0,    12,
       0,    42,    47,    48,     0,    42,    47,     9,    48,     0,
      49,    65,    50,     0,    70,     0,    15,    59,     0,    59,
      15,    60,     0,    51,     0,     3,     0,    52,     0,     0,
      78,     0,    11,     0,    47,    70,    48,     0,     9,     0,
      10,     0,    72,     0,    14,    47,    48,     0,    14,    47,
      73,    48,     0,    74,     0,    73,    53,    74,     0,    70,
       0,    76,     0,    75,    54,    76,     0,    57,     0,    77,
       0,    77,    46,    59,     0,    77,    15,    59,     0,    71,
       0,    71,    61,     0,    79,     0,    78,    21,    79,     0,
      80,     0,    79,    22,    80,     0,    81,     0,    80,    45,
      81,     0,    82,     0,    81,    44,    82,     0,    83,     0,
      82,    55,    83,     0,    82,    56,    83,     0,    84,     0,
      83,    13,    84,     0,    75,     0,    56,    75,     0
};
...
static const char* const rule_info[] = {
  ...
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 466",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 469",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 484",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 487",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 502",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 505",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 520",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 523",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 538",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 541",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 552",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 567",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 570",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 585",
  "amara/xpath/parser/xpath_grammar.bgen.frag: line 588"
};
...
static const int default_action[] = {
      26,    24,    30,    31,    28,     0,    26,     0,     3,    26,
      23,    25,    26,    40,     2,     1,     6,     0,     5,     8,
      11,    15,    44,    32,    59,    38,    41,    27,    46,    48,
      50,    52,    54,    57,    26,    21,    14,     4,     0,    60,
...
static const int action_idx[] = {
      -3,-32768,-32768,-32768,-32768,   -42,    13,    31,    43,    -3,
  -32768,-32768,    66,-32768,-32768,   -14,-32768,    -8,-32768,-32768,
  -32768,-32768,   -32,-32768,   -23,-32768,   -13,    -2,    17,     6,
      24,   -46,    48,-32768,    11,   -14,-32768,   -14,    34,   -23,
      47,    47,-32768,    37,   -32,    27,   -32,-32768,    93,    49,
      49,    27,    27,    27,    27,    27,    27,    27,-32768,-32768,
     -35,-32768,-32768,-32768,-32768,    18,   -32,    41,-32768,-32768,
  -32768,   -14,   -14,    17,     6,    24,   -46,    48,    48,-32768,
  -32768,    27,    45,-32768,-32768,-32768,-32768,    87,    97,-32768
};
...
static const int goto_idx[] = {
  -32768,-32768,    39,   -12,    61,-32768,-32768,   -43,-32768,-32768,
  -32768,-32768,-32768,    15,-32768,-32768,-32768,    25,    98,    63,
  -32768,-32768,    64,    62,    67,    65,    16,    59
};

/* A vector filled with portions for different uses.
   (using action_idx and goto_idx) */
static const int yytable[] = {
       1,    40,    49,    69,    42,    34,     2,     3,     4,    55,
      56,     5,     6,    80,     1,    87,     1,    45,    81,    51,
       2,     3,     4,    69,    38,     5,     6,    82,    63,    64,
       1,    48,    41,    50,    43,    36,     2,     3,     4,    52,
       7,     5,     6,     8,     9,    35,     1,    37,    10,    11,
       1,    53,     1,    12,     7,   -26,     7,     8,     9,    58,
      68,    57,    10,    11,    10,    11,    83,    12,    54,     1,
       7,    77,    78,     8,     9,     2,     3,     4,    10,    11,
       5,     6,    62,    12,    65,   -26,     7,    88,    71,    72,
       7,    84,     7,    86,    10,    11,     1,    89,    10,    11,
      10,    11,     2,     3,     4,    66,    85,     5,     6,     7,
      39,    70,     8,     9,    74,    73,    79,    10,    11,    76,
...
static const int yycheck[] = {
       3,    15,    15,    46,    12,    47,     9,    10,    11,    55,
      56,    14,    15,    48,     3,     0,     3,    49,    53,    21,
       9,    10,    11,    66,     9,    14,    15,     9,    40,    41,
       3,    54,    46,    46,    42,     4,     9,    10,    11,    22,
      43,    14,    15,    46,    47,     6,     3,     8,    51,    52,
       3,    45,     3,    56,    43,    12,    43,    46,    47,    48,
      45,    13,    51,    52,    51,    52,    48,    56,    44,     3,
      43,    55,    56,    46,    47,     9,    10,    11,    51,    52,
      14,    15,    48,    56,    47,    42,    43,     0,    49,    50,
      43,    50,    43,    48,    51,    52,     3,     0,    51,    52,
      51,    52,     9,    10,    11,    44,    81,    14,    15,    43,
      12,    48,    46,    47,    52,    51,    57,    51,    52,    54,
...
case 34: {
   ...
   * FunctionCall: FUNCTION_NAME '(' Argument.list ')'
   */
...
case 47: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 469
...
case 49: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 487
...
case 51: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 505
...
case 53: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 523
...
case 55: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 541
...
case 56: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 552
   * AdditiveExpr: AdditiveExpr '-' MultiplicativeExpr
   */
  yyval = PyObject_CallFunction(additive_expr, "OOO", value_ptr[1], value_ptr[2], value_ptr[3]);
  if (self->verbose) {
...
case 58: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 570
...
case 60: {
  /* from amara/xpath/parser/xpath_grammar.bgen.frag, line 588
   * UnaryExpr: '-' UnionExpr
   */
...
case 0: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[8], ");
...
case 1: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[13], ");
  lexer->state = LEXER_INITIAL;
  TRACE("switching to start condition INITIAL, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 2: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[18], ");
  lexer->state = LEXER_INITIAL;
  TRACE("switching to start condition INITIAL, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 3: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[24], ");
...
case 4: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[26], ");
  lexer->state = LEXER_INITIAL;
  TRACE("switching to start condition INITIAL, ");
  break;
}
case 5: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[31], ");
...
case 6: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[36], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 7: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[40], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 8: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[44], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 9: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[48], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 10: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[53], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 11: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[58], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 12: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[63], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 13: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[68], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 14: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[73], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 15: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[78], ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
  if (*yylval == NULL) {
    PyErr_NoMemory();
...
case 16: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[82], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 17: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[87], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 18: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[93], ");
  lexer->state = LEXER_OPERATOR;
  TRACE("switching to start condition OPERATOR, ");
  /* create the Python object for the matched text */
  *yylval = PyUnicode_FromUnicode(yytext, yylen);
...
case 19: {
  ...
  TRACE("using rule from amara/xpath/parser/xpath_lexer_patterns.bgen.frag[99], ");
  /* skip over the matched text */
  yytext = lexer->position;
  break;
}
...
static PyTypeObject Parser_Type = {
  ...
  /* ob_size           */ 0,
  /* tp_name           */ MODULE_NAME "." PARSER_NAME,
...
PyMODINIT_FUNC MODULE_INITFUNC(void) {
  ...
  module = Py_InitModule("_" PARSER_NAME, module_methods);
