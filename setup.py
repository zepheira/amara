...
setup(name='Amara',
      ...
      ext_modules=[
          ...
          Extension('amara._domlette',
                    ...
                    include_dirs=['amara/src', 'amara/src/expat'],
                    sources=['amara/src/domlette/nss.c',
                             # DOM interfaces
                             'amara/src/domlette/exceptions.c',
                             'amara/src/domlette/domimplementation.c',
                             'amara/src/domlette/node.c',
                             #'amara/src/domlette/nodelist.c',
                             'amara/src/domlette/namednodemap.c',
                             ...
                             'amara/src/domlette/xpathnamespace.c',
                             # Document builder
