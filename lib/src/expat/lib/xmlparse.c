...
typedef uintptr_t XML_uintptr_t;
#elif SIZEOF_VOID_P <= SIZEOF_INT
typedef unsigned int XML_uintptr_t;
#elif SIZEOF_VOID_P <= SIZEOF_LONG
typedef unsigned long XML_uintptr_t;
#else
#    error Expat needs a typedef for XML_uintptr_t.
...
#define MUST_CONVERT(enc, s) (!(enc)->isUtf32 || (((XML_uintptr_t)(s)) & 3))
...
#define MUST_CONVERT(enc, s) (!(enc)->isUtf16 || (((XML_uintptr_t)(s)) & 1))
#else
...
#if defined(XML_UNICODE_WIDE)
typedef ICHAR32 ICHAR;
#elif defined(XML_UNICODE)
typedef ICHAR16 ICHAR;
#else
typedef ICHAR8 ICHAR;
#endif
