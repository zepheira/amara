...
from amara import sax, inputsource
from amara._xmlstring import is_xml_space
from amara.lib import truncate, UriError
...
from amara.xslt.tree import xslt_node, xslt_element, ELEMENT_CLASSES
